...
var callAPI = function (fetch, loginData, action, command, id_or_data, data) {
    if (id_or_data === void 0) { id_or_data = undefined; }
    if (data === void 0) { data = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var id, _a, url, request;
        return __generator(this, function (_b) {
            if (isNaN(Number(id_or_data)))
                data = id_or_data;
            else
                id = Number(id_or_data);
            _a = (0, exports.buildRequestData)(loginData, action, command, data, id), url = _a.url, request = _a.request;
            return [2, fetch(url, request).then(function (r) { return r.json(); }).then(handleResult)];
        });
    });
};
